...
export default function IndustryChallenges({ industryName = "Agriculture" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Technical Talent Gap", description: "Finding specialized engineers for both traditional resource extraction and renewable energy." },
  { icon: <Icons.Skills />, title: "Sustainability Standards", description: "Recruiting experts who can implement eco-friendly initiatives and carbon-reduction technologies." },
  { icon: <Icons.Safety />, title: "Remote Site Logistics", description: "Sourcing reliable workforces for projects in geographically isolated or high-risk areas." }
];
