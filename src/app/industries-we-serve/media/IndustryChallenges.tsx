...
export default function IndustryChallenges({ industryName = "Media & Communication" }: Props) {
   
const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Digital Shift", description: "Finding traditional media experts who have transitioned successfully to digital-first strategies." },
  { icon: <Icons.Skills />, title: "Audience Fragmentation", description: "Recruiting specialists who can engage diverse audiences across multiple social and news platforms." },
  { icon: <Icons.Safety />, title: "Deadline Pressure", description: "Handling high-volume recruitment for fast-moving newsrooms and PR agencies." }
];
