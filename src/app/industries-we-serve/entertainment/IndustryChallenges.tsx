...
export default function IndustryChallenges({ industryName = "Entertainment" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Collaborative Harmony", description: "Recruiting individuals who can work seamlessly across different creative and technical departments." },
  { icon: <Icons.Skills />, title: "Technical Innovation", description: "Finding talent expert in modern production tech, from VR/AR to advanced digital editing." },
  { icon: <Icons.Safety />, title: "Tight Production Deadlines", description: "Managing rapid staff scaling to meet strict project release or live event dates." }
];
