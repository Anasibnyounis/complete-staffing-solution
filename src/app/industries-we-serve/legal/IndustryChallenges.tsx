...
export default function IndustryChallenges({ industryName = "Legal" }: Props) {
 const CHALLENGES = [
  { icon: <Icons.Demands />, title: "High Precision Work", description: "The legal field allows zero room for error in documentation and case preparation." },
  { icon: <Icons.Skills />, title: "Ethics & Integrity", description: "Finding candidates with a proven track record of upholding high ethical and professional standards." },
  { icon: <Icons.Safety />, title: "Complex Case Loads", description: "Scaling staff to handle sudden spikes in litigation or complex corporate mergers." }
];
