...
export default function IndustryChallenges({ industryName = "Design" }: Props) {
  const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Technical Mastery", description: "Finding creative talent that is also proficient in the latest design software and collaborative tools." },
  { icon: <Icons.Skills />, title: "Creative Burnout", description: "Recruiting resilient designers who can maintain high-quality output under tight creative deadlines." },
  { icon: <Icons.Safety />, title: "Portfolio Vetting", description: "Ensuring candidates have a proven track record that aligns with your specific brand aesthetics." }
];
