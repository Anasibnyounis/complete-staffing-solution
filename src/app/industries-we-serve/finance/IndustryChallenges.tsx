...
export default function IndustryChallenges({ industryName = "Agriculture" }: Props) {
  const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Regulatory Changes", description: "Staying compliant with ever-changing financial laws and international accounting standards." },
  { icon: <Icons.Skills />, title: "Data Security", description: "The need for professionals who can handle sensitive data with high integrity and technical security." },
  { icon: <Icons.Safety />, title: "Risk Management", description: "Recruiting experts who can accurately forecast and mitigate financial risks for the organization." }
];
