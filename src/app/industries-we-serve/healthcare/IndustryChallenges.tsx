...
export default function IndustryChallenges({ industryName = "Agriculture" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Staff Burnout", description: "High turnover rates due to stressful environments requiring resilient and dedicated staff." },
  { icon: <Icons.Skills />, title: "Credential Verification", description: "Ensuring all medical professionals have valid, up-to-date licenses and specialized certifications." },
  { icon: <Icons.Safety />, title: "Patient Care Standards", description: "Recruiting talent that prioritizes patient safety and adheres to strict medical ethics." }
];
