...
export default function IndustryChallenges({ industryName = "Consumer Goods" }: Props) {
    const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Rapid Market Evolution", description: "Sourcing talent that can adapt to fast-changing consumer trends and omni-channel retail shifts." },
  { icon: <Icons.Skills />, title: "Supply Chain Disruptions", description: "Finding logistics and inventory experts who can navigate global supply chain complexities efficiently." },
  { icon: <Icons.Safety />, title: "Brand Integrity", description: "Recruiting marketing and quality professionals who prioritize and protect your brand's reputation." }
];
