...
export default function IndustryChallenges({ industryName = "Wellness & Fitness" }: Props) {
 const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Client Accountability", description: "Recruiting trainers who can consistently motivate clients and drive long-term results." },
  { icon: <Icons.Skills />, title: "Certification Standards", description: "Ensuring all wellness staff possess the latest accredited certifications and medical safety knowledge." },
  { icon: <Icons.Safety />, title: "Motivational Consistency", description: "Finding staff who can maintain high energy and empathy levels in a client-facing environment." }
];
