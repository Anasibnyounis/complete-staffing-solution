...
export default function IndustryChallenges({ industryName = "Agriculture" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Diverse Learning Needs", description: "Recruiting educators who are trained in modern, inclusive teaching methodologies." },
  { icon: <Icons.Skills />, title: "Staff Retention", description: "Combating high turnover in the education sector by finding truly passionate and resilient talent." },
  { icon: <Icons.Safety />, title: "Regulatory Compliance", description: "Ensuring all staff meet strict background checks and state-mandated educational certifications." }
];
