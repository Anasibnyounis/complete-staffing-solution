...
export default function IndustryChallenges({ industryName = "Arts" }: Props) {
    const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Highly Specialized Skillsets", description: "Finding talent with niche or advanced skills required for specific creative projects can be difficult." },
  { icon: <Icons.Skills />, title: "Project-based Hiring", description: "Short-term or freelance projects make recruitment and retention of top artists more challenging." },
  { icon: <Icons.Safety />, title: "Artistic Vision Alignment", description: "Ensuring that hired talent shares the same creative direction or style as the artistic project." }
];
