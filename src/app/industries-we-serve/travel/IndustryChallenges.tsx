...
export default function IndustryChallenges({ industryName = "Recreation & Travel" }: Props) {
  const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Seasonal Fluctuations", description: "Managing rapid staff scaling for peak holiday seasons and tourism surges." },
  { icon: <Icons.Skills />, title: "Service Consistency", description: "Ensuring high-quality guest experiences by finding talent with exceptional soft skills." },
  { icon: <Icons.Safety />, title: "Safety Protocols", description: "Maintaining guest and staff safety in diverse environments like resorts and tour sites." }
];
