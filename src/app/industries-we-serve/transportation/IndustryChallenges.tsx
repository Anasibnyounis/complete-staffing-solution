...
export default function IndustryChallenges({ industryName = "Transportation & Logistics" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Inventory Accuracy", description: "Combating loss and inefficiency by recruiting data-driven warehouse and logistics leads." },
  { icon: <Icons.Skills />, title: "Global Logistics", description: "Sourcing managers who understand international shipping regulations and customs." },
  { icon: <Icons.Safety />, title: "Shipping Delays", description: "Finding agile coordinators who can solve route problems and maintain delivery speeds." }
];
