...
export default function IndustryChallenges({ industryName = "Software & IT Services" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Rapid Tech Evolution", description: "Keeping pace with new programming languages, frameworks, and security threats." },
  { icon: <Icons.Skills />, title: "Global Talent War", description: "Competitive landscape makes it difficult to retain high-level developers and architects." },
  { icon: <Icons.Safety />, title: "Cybersecurity Risks", description: "Recruiting specialists who can safeguard infrastructure against sophisticated cyber-attacks." }
];
