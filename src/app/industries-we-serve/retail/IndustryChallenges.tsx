...
export default function IndustryChallenges({ industryName = "Retail" }: Props) {
    const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Omni-channel Shifts", description: "Recruiting staff who can provide a seamless experience across both physical and online stores." },
  { icon: <Icons.Skills />, title: "Seasonal Hiring", description: "Efficiently managing large-scale temporary staffing for holiday peaks and sale events." },
  { icon: <Icons.Safety />, title: "Customer Retention", description: "Finding front-line staff with the charisma and knowledge to build long-term loyalty." }
];
