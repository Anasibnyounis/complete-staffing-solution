...
export default function IndustryChallenges({ industryName = "Public Administration" }: Props) {
    
const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Policy Implementation", description: "Finding administrative talent capable of navigating complex bureaucracy to execute policies." },
  { icon: <Icons.Skills />, title: "Public Trust", description: "Recruiting accountable professionals who prioritize transparency and community service." },
  { icon: <Icons.Safety />, title: "Budget Restrictions", description: "Sourcing high-quality staff within the constraints of public sector financial frameworks." }
];
