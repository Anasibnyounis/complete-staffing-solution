...
export default function IndustryChallenges({ industryName = "Construction" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Labor Shortage", description: "The industry faces a critical lack of skilled tradespeople like electricians and plumbers." },
  { icon: <Icons.Skills />, title: "Tight Project Deadlines", description: "Scaling a workforce quickly to meet strict completion dates without sacrificing quality." },
  { icon: <Icons.Safety />, title: "Safety & OSHA Compliance", description: "Ensuring all workers are trained and compliant with strict safety regulations on-site." }
];
