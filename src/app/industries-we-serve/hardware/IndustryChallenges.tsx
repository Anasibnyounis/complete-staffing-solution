...
export default function IndustryChallenges({ industryName = "Hardware & Networking" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "System Scalability", description: "Recruiting engineers who can build and maintain infrastructures that grow with the business." },
  { icon: <Icons.Skills />, title: "24/7 Uptime Demands", description: "Finding reliable on-call technicians who can manage mission-critical network issues instantly." },
  { icon: <Icons.Safety />, title: "Cybersecurity Risks", description: "Sourcing hardware and network experts who prioritize data security and threat prevention." }
];
