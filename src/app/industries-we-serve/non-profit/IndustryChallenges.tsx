...
export default function IndustryChallenges({ industryName = "Non Profit" }: Props) {
   const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Mission Alignment", description: "Ensuring candidates are not just skilled but deeply committed to your organization's social goals." },
  { icon: <Icons.Skills />, title: "Fundraising Gaps", description: "Finding development professionals who can navigate competitive grant and donation landscapes." },
  { icon: <Icons.Safety />, title: "Impact Measurement", description: "Recruiting program managers who can effectively demonstrate social return on investment." }
];
