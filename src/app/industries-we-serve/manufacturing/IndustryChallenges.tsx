...
export default function IndustryChallenges({ industryName = "Manufacturing" }: Props) {
  const CHALLENGES = [
  { icon: <Icons.Demands />, title: "Automation Gaps", description: "Transitioning to smart manufacturing requires workers with both manual and tech skills." },
  { icon: <Icons.Skills />, title: "Quality Consistency", description: "Maintaining zero-defect standards while scaling production during peak demand." },
  { icon: <Icons.Safety />, title: "Workplace Hazards", description: "Ensuring all personnel are rigorously trained on heavy machinery safety and protocols." }
];
