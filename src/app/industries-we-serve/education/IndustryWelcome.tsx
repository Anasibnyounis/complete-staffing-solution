    ...
    <section className={styles.section}>
      <div className={styles.container}>
        <div className={styles.content}>
          <h2 className={styles.title}>Welcome to Education Staffing</h2>
          <p className={styles.description}>
Tailored recruitment for K-12, higher ed, and nonprofits, focusing on instructional excellence and leadership.                  </p>
