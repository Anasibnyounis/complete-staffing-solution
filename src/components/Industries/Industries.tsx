...
export default function Industries() {
  ...
  return (
    <section className="w-full relative bg-[#b9c6dc]/30 overflow-hidden flex flex-col items-center py-2 px-4 sm:py-2 sm:px-6 md:py-2 md:px-8 2xl:py-2 2xl:px-8">
      <div
        ref={statsRef}
        className={`w-full rounded-2xl 2xl:rounded-none bg-[#19478e] overflow-hidden py-6 px-6 sm:py-8 sm:px-8 md:py-9 md:px-10 lg:py-10 lg:px-12 2xl:py-12 2xl:px-16
      ...
      >
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="font-bold uppercase text-[clamp(24px,4vw,40px)] leading-tight text-white transition-transform duration-300 hover:scale-105">
              {stat.number}
            </div>
            <div className="font-[var(--font-inter)] text-sm sm:text-base text-white text-center leading-snug max-w-[314px]">
              {stat.description}
            </div>
          </div>
        ))}
